...
Pasta de conhecimento técnico que o Flori (agente Telegram) lê pra responder dúvidas de metalurgia, normas, conversões e catálogo. **Basta salvar o arquivo aqui** (`.md` ou `.pdf`) — o Flori enxerga automaticamente na próxima pergunta, sem precisar avisar ninguém.
